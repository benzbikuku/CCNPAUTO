...
# my_pattern = re.compile(r"(?P<ProcessorFamily>\S.+) @ (?P<ProcessorSpeed>\S+) with \d+ \S+ of memory.", flags="m")
my_pattern = re.compile(r"(?P<ProcessorFamily>\S.+) \n .+ with (?P<Memory>\d+) \S+ of memory.")
